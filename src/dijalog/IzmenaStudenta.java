...
public class IzmenaStudenta extends JDialog {
	...
	public IzmenaStudenta(Frame parent, String title, boolean modal) {
		...
		int red = TrakaSaAlatkama.getInstance().getSelektovanRed();
		...
		//TODO: za sad ne radi nista
		
		panDugmePonisti.add(btnPonisti);
		
		double prosek = BazaStudenata.getInstance().getRow(red).getProsecnaOcena();
		...
		JLabel labESPB = new JLabel("Ukupno ESPB: " + 0);
