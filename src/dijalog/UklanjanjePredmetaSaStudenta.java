...
public class UklanjanjePredmetaSaStudenta extends JDialog {
	...
	public UklanjanjePredmetaSaStudenta (Frame parent, String title, boolean modal) {
		...
		JLabel label = new JLabel("<html>Da li ste sigurni da želite<br/> da obrišete predmet?<html>");	//da bi se sve ispisalo
		label.setPreferredSize(dim);
		panPoruka.add(label);
		
		int red = TabelaNepolozenih.getInstance().getTabelaNepolozenih().getSelectedRow();	
		Predmet predmet = BazaNepolozenih.getInstance().getRow(red);
